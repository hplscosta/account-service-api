...
public class AccountEndpointAdvice {
	...
	/**
	 * Exception when the request is invalid. Retrieves HttpStatus.NOT_FOUND.
	 *
	 * @param e {@link AccountNotFoundException}
	 * @return a {@link ResponseEntity} with {@link ErrorMessage}
	 */
	@ExceptionHandler( value = AccountNotFoundException.class )
	public ResponseEntity<ErrorMessage> handle( AccountNotFoundException e ) {
